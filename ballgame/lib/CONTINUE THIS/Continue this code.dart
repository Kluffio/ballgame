...
class _MainMenuState extends State<MainMenu> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: MainMenu.leagues.length, vsync: this);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              margin: const EdgeInsets.symmetric(horizontal: 16),
              decoration: BoxDecoration(
                color: MainMenu.leagues[selectedLeagueIndex].color.withOpacity(0.2),
                borderRadius: BorderRadius.circular(15),
                border: Border.all(
            ...
            Expanded(
              child: TabBarView(
                ...
                children: MainMenu.leagues.map((league) {
                  ...
                  final leagueLevels = MainMenu.levels.where((level) => level.league == league).toList();
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isUnlocked = UserProgress.unlockedLevels[levelIndex];
      ...
      child: InkWell(
        onTap: isUnlocked ? () {
          Navigator.push(
            ...
            if (context.findAncestorStateOfType<_MainMenuState>() != null) {
              context.findAncestorStateOfType<_MainMenuState>()!.setState(() {});
            }
          });
        } : null,
        borderRadius: BorderRadius.circular(15),
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [
                isUnlocked ? level.color.withOpacity(0.6) : Colors.grey.withOpacity(0.6),
...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  void _addObstacle() {
    ...
    bool isMovingPlatform = widget.level.hasMovingPlatforms && random.nextDouble() > 0.7;
    double speedX = 0.0;
  ...
  void _updateObstacles() {
    ...
    obstacles.removeWhere((obstacle) {
      ...
      if (obstacle.isMovingPlatform) {
        ...
        obstacle.x = obstacle.originalX + sin(frameCount * obstacle.speedX) * obstacle.amplitude;
  ...
  void _goToNextLevel(BuildContext context) {
    ...
    if (currentIndex < MainMenu.levels.length - 1 && UserProgress.unlockedLevels[currentIndex + 1]) {
